...
- 🚧 **v1.0.0 — PC Import (Pathbuilder 2e)** — Phases 42-46 (in progress)
...
| 46. PC Combat Polish | v1.0.0 | 4/4 | Complete    | 2026-04-07 |

### Phase 46: PC Combat Polish
**Goal**: Combat tracker and encounters are polished for PC use — dedicated PC tab in the left panel for adding PCs to combat, PC character card visible in the right stat panel, initiative editable for PCs, combat/encounter creature lists filterable like the bestiary, and hazards get initiative roll support
**Depends on**: Phase 45
**Success Criteria** (what must be TRUE):
  1. Left panel in combat tracker has a "Characters" tab (alongside bestiary search) listing all imported PCs — clicking adds them to the active encounter
  2. "Add to Combat" on Characters page shows a dropdown/picker to select which active encounter to add the PC to
  3. PC initiative value is editable in the combat tracker (click to set, same as NPC)
  4. Selecting a PC combatant shows their stat card in the right panel — ability scores, saves, skills, AC, HP with modifiers visible
  5. Combat tracker creature list and Encounters page creature list have tier/type filter chips matching the bestiary browser
  6. Hazards in the initiative list have a "Roll Initiative" button (Perception + modifier or Stealth DC as applicable)
**Plans:** 4/4 plans complete
**UI hint**: yes

---
*Roadmap created: 2026-03-31 — v0.2.2-pre-alpha fresh start*
*Last updated: 2026-04-07 — Phase 46 added: PC Combat Polish
